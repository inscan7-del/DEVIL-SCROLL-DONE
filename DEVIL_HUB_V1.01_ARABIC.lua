...
prefabs.الحجم = UDim2.new(0, 100, 0, 100)
...
label.الحجم = UDim2.new(0, 200, 0, 20)
...
window.الحجم = UDim2.new(0, 200, 0, 200)
...
resizer.BorderالحجمPixel = 0
resizer.Position = UDim2.new(1, -20, 1, -20)
resizer.الحجم = UDim2.new(0, 20, 0, 20)

bar.Name = "Bar"
bar.Parent = window
bar.BackgroundColor3 = Color3.new(0.160784, 0.290196, 0.478431)
bar.BorderالحجمPixel = 0
bar.Position = UDim2.new(0, 0, 0, 5)
bar.الحجم = UDim2.new(1, 0, 0, 15)
...
toggle.Rotation = 0
toggle.الحجم = UDim2.new(0, 20, 0, 20)
toggle.ZIndex = 2
...
base.BorderالحجمPixel = 0
base.Position = UDim2.new(0, 0, 0.800000012, 0)
base.الحجم = UDim2.new(1, 0, 0, 10)
...
tabs.الحجم = UDim2.new(1, -30, 1, -60)
...
titleLabel.الحجم = UDim2.new(0, 200, 0, 20)
titleLabel.Font = Enum.Font.GothamBold
titleLabel.Text = "وقت اللعب"
titleLabel.TextColor3 = Color3.new(1, 1, 1)
titleLabel.Textالحجم = 14
...
tabSelection.الحجم = UDim2.new(1, -30, 0, 25)
...
tabButtons.الحجم = UDim2.new(1, 0, 1, 0)
tabButtons.BorderالحجمPixel = 0
tabButtons.Canvasالحجم = UDim2.new(0, 0, 0, 0)
...
tabButtons.AutomaticCanvasالحجم = Enum.Automaticالحجم.X
...
uiListLayout:GetPropertyChangedSignal("AbsoluteContentالحجم"):Connect(function()
	tabButtons.Canvasالحجم = UDim2.new(0, uiListLayout.AbsoluteContentالحجم.X + 8, 0, 0)
end)

frame.Parent = tabSelection
frame.BackgroundColor3 = Color3.new(0.12549, 0.227451, 0.372549)
frame.BorderColor3 = Color3.new(0.105882, 0.164706, 0.207843)
frame.BorderالحجمPixel = 0
frame.Position = UDim2.new(0, 0, 1, 0)
frame.الحجم = UDim2.new(1, 0, 0, 2)

tab.Name = "Tab"
tab.Parent = prefabs
tab.BackgroundColor3 = Color3.new(1, 1, 1)
tab.BackgroundTransparency = 1
tab.الحجم = UDim2.new(1, 0, 1, 0)
tab.Visible = false
tab.BorderالحجمPixel = 0
tab.Canvasالحجم = UDim2.new(0, 0, 0, 0)
...
tab.AutomaticCanvasالحجم = Enum.Automaticالحجم.Y
...
uiListLayout2:GetPropertyChangedSignal("AbsoluteContentالحجم"):Connect(function()
	tab.Canvasالحجم = UDim2.new(0, 0, 0, uiListLayout2.AbsoluteContentالحجم.Y + 10)
end)

textBox.Parent = prefabs
textBox.BackgroundColor3 = Color3.new(1, 1, 1)
textBox.BackgroundTransparency = 1
textBox.BorderالحجمPixel = 0
textBox.الحجم = UDim2.new(1, 0, 0, 20)
textBox.ZIndex = 2
...
textBoxRoundify4px.الحجم = UDim2.new(1, 0, 1, 0)
...
slider.الحجم = UDim2.new(1, 0, 0, 20)
...
dropdownIndicator.الحجم = UDim2.new(0, 15, 0, 15)
...
dropdownBox.الحجم = UDim2.new(1, 0, 0, 150)
...
dropdownObjects.BorderالحجمPixel = 0
dropdownObjects.الحجم = UDim2.new(1, 0, 1, 0)
dropdownObjects.ZIndex = 3
dropdownObjects.Canvasالحجم = UDim2.new(0, 0, 0, 0)
...
textButtonRoundify4px.الحجم = UDim2.new(1, 0, 1, 0)
...
textButtonRoundify4px_2.الحجم = UDim2.new(1, 0, 1, 0)
...
folder.الحجم = UDim2.new(1, 0, 0, 20)
...
button.BorderالحجمPixel = 0
button.الحجم = UDim2.new(1, 0, 0, 20)
button.ZIndex = 2
...
textButtonRoundify4px_3.الحجم = UDim2.new(1, 0, 1, 0)
...
textButtonRoundify4px_3.SliceCenter = Rect.new(4, 4, 4, 4)
	...
	toggle2.الحجم = UDim2.new(0, 20, 0, 20)
...
objects2.الحجم = UDim2.new(1, -10, 1, -25)
...
horizontalAlignment.الحجم = UDim2.new(1, 0, 0, 20)
...
console.الحجم = UDim2.new(1, 0, 0, 200)
...
scrollingFrame.BorderالحجمPixel = 0
scrollingFrame.الحجم = UDim2.new(1, 0, 1, 1)
scrollingFrame.Canvasالحجم = UDim2.new(0, 0, 0, 0)
...
source.الحجم = UDim2.new(1, -40, 0, 10000)
source.ZIndex = 3
...
infoLabel.الحجم = UDim2.new(1, 0, 1, 0)
infoLabel.ZIndex = 5
infoLabel.Font = Enum.Font.Code
infoLabel.Text = ""
infoLabel.TextColor3 = Color3.new(0, 0.635294, 1)
infoLabel.Textالحجم = 15
...
linesLabel.BorderالحجمPixel = 0
linesLabel.الحجم = UDim2.new(0, 40, 0, 10000)
linesLabel.ZIndex = 4
linesLabel.Font = Enum.Font.Code
linesLabel.Text = "1\n"
linesLabel.TextColor3 = Color3.new(1, 1, 1)
linesLabel.Textالحجم = 15
...
colorPicker.الحجم = UDim2.new(0, 180, 0, 110)
...
palette.الحجم = UDim2.new(0, 100, 0, 100)
...
indicator3.الحجم = UDim2.new(0, 5, 0, 5)
indicator3.ZIndex = 2
...
sample.الحجم = UDim2.new(0, 25, 0, 25)
...
textButtonRoundify4px_4.الحجم = UDim2.new(1, 0, 1, 0)
...
button2.BorderالحجمPixel = 0
button2.الحجم = UDim2.new(0, 91, 0, 20)
button2.ZIndex = 2
button2.Font = Enum.Font.GothamSemibold
button2.TextColor3 = Color3.new(1, 1, 1)
button2.Textالحجم = 14
...
textButtonRoundify4px_5.الحجم = UDim2.new(1, 0, 1, 0)
...
dropdownButton.BorderالحجمPixel = 0
dropdownButton.الحجم = UDim2.new(1, 0, 0, 20)
dropdownButton.ZIndex = 3
dropdownButton.Font = Enum.Font.GothamSemibold
dropdownButton.Text = "      Button"
dropdownButton.TextColor3 = Color3.new(0.784314, 0.784314, 0.784314)
dropdownButton.Textالحجم = 14
...
keybind.الحجم = UDim2.new(0, 200, 0, 20)
...
title4Label.الحجم = UDim2.new(0, 0, 1, 0)
...
inputButton.BorderالحجمPixel = 0
inputButton.Position = UDim2.new(1, -85, 0, 2)
inputButton.الحجم = UDim2.new(0, 80, 1, -4)
...
inputRoundify4px.الحجم = UDim2.new(1, 0, 1, 0)
...
windowsFrame.الحجم = UDim2.new(1, 20, 1, -20)
...
local function ripple(button, x, y)
	spawn(function()
		...
		local size = 0
		if button.Absoluteالحجم.X > button.Absoluteالحجم.Y then
			size = button.Absoluteالحجم.X * 1.5
		elseif button.Absoluteالحجم.X < button.Absoluteالحجم.Y then
			size = button.Absoluteالحجم.Y * 1.5
		elseif button.Absoluteالحجم.X == button.Absoluteالحجم.Y then
			size = button.Absoluteالحجم.X * 1.5
		end

		circle:TweenالحجمAndPosition(UDim2.new(0, size, 0, size), UDim2.new(0.5, -size / 2, 0.5, -size / 2), "Out", "Quad", 0.5, false, nil)
...
function library:AddWindow(title, options)
	...
	Window.الحجم = UDim2.new(0, options.min_size.X, 0, options.min_size.Y)
					...
					if Entered and Resizer.Active and options.can_resize then
						while Held and Resizer.Active do
							...
							if x >= options.min_size.X and y >= options.min_size.Y then
								Resize(Window, {الحجم = UDim2.new(0, x, 0, y)}, options.tween_time)
							elseif x >= options.min_size.X then
								Resize(Window, {الحجم = UDim2.new(0, x, 0, options.min_size.Y)}, options.tween_time)
							elseif y >= options.min_size.Y then
								Resize(Window, {الحجم = UDim2.new(0, options.min_size.X, 0, y)}, options.tween_time)
							else
								Resize(Window, {الحجم = UDim2.new(0, options.min_size.X, 0, options.min_size.Y)}, options.tween_time)
							end
	...
	do -- [Open / Close] Window
		...
		local oldwindowdata = {}
		local oldy = Window.Absoluteالحجم.Y
		open_close.MouseButton1Click:Connect(function()
			if canopen then
				...
				if open then
					...
					oldy = Window.Absoluteالحجم.Y
					Resize(Window, {الحجم = UDim2.new(0, Window.Absoluteالحجم.X, 0, 26)}, options.tween_time)
					...
					Resize(Window, {الحجم = UDim2.new(0, Window.Absoluteالحجم.X, 0, oldy)}, options.tween_time)
	...
	do -- UI Elements
		...
		do -- Add Tab
			function window_data:AddTab(tab_name)
				...
				new_button.الحجم = UDim2.new(0, gNameLen(new_button), 0, 20)
				...
				-- cloned tabs could keep a zero Canvasالحجم on mobile.
				-- ============================================================
				...
				local function updateTabCanvas()
					if new_tab and new_tab_layout then
						local contentHeight = new_tab_layout.AbsoluteContentالحجم.Y + 12
						new_tab.Canvasالحجم = UDim2.new(0, 0, 0, math.max(contentHeight, new_tab.Absoluteالحجم.Y))
					end
				end
				if new_tab_layout then
					new_tab_layout:GetPropertyChangedSignal("AbsoluteContentالحجم"):Connect(updateTabCanvas)
				end
				...
				new_tab:GetPropertyChangedSignal("Absoluteالحجم"):Connect(updateTabCanvas)
				task.defer(updateTabCanvas)
				...
				local function updateTabBarCanvas()
					local contentWidth = uiListLayout.AbsoluteContentالحجم.X + 12
					tab_buttons.Canvasالحجم = UDim2.new(0, math.max(contentWidth, tab_buttons.Absoluteالحجم.X), 0, 0)
				end
				uiListLayout:GetPropertyChangedSignal("AbsoluteContentالحجم"):Connect(updateTabBarCanvas)
				tab_buttons:GetPropertyChangedSignal("Absoluteالحجم"):Connect(updateTabBarCanvas)
				...
				local function show()
					...
					for i, v in pairs(tab_buttons:GetChildren()) do
						if not (v:IsA("UIListLayout")) then
							...
							Resize(v, {الحجم = UDim2.new(0, v.Absoluteالحجم.X, 0, 20)}, options.tween_time)
						end
					end
					...
					Resize(new_button, {الحجم = UDim2.new(0, new_button.Absoluteالحجم.X, 0, 25)}, options.tween_time)
				...
				do -- Tab Elements
					...
					function tab_data:AddLabel(label_text) -- [Label]
						...
						label.الحجم = UDim2.new(0, gNameLen(label), 0, 20)
					...
					function tab_data:AddButton(button_text, callback) -- [Button]
						...
						button.الحجم = UDim2.new(0, gNameLen(button), 0, 20)
					...
					function tab_data:AddSlider(slider_text, callback, slider_options)
						...
						do -- Slider Math
									...
									spawn(function() -- Loop check
										if Entered and not slider_options.readonly then
											while Held and (not dropdown_open) do
												local mouse_location = gMouse()
												local x = (slider.Absoluteالحجم.X - (slider.Absoluteالحجم.X - ((mouse_location.X - slider.AbsolutePosition.X)) + 1)) / slider.Absoluteالحجم.X
												...
												Resize(indicator, {الحجم = UDim2.new(size or min, 0, 0, 20)}, options.tween_time)
							...
							function slider_data:Set(new_value)
								...
								Resize(indicator, {الحجم = UDim2.new(new_value or 0, 0, 0, 20)}, options.tween_time)
					...
					function tab_data:AddKeybind(keybind_name, callback, keybind_options)
						...
						keybind.الحجم = UDim2.new(0, gNameLen(title) + 80, 0, 20)
					...
					function tab_data:AddDropdown(dropdown_name, callback)
						...
						dropdown.MouseButton1Click:Connect(function()
							...
							if #objects:GetChildren() - 1 >= 10 then
								len = 10 * 20
								objects.Canvasالحجم = UDim2.new(0, 0, (#objects:GetChildren() - 1) * 0.1, 0)
							end

							if open then -- Open
								if dropdown_open then return end
								dropdown_open = true
								Resize(box, {الحجم = UDim2.new(1, 0, 0, len)}, options.tween_time)
								Resize(indicator, {Rotation = 90}, options.tween_time)
							else -- Close
								dropdown_open = false
								Resize(box, {الحجم = UDim2.new(1, 0, 0, 0)}, options.tween_time)
								Resize(indicator, {Rotation = -90}, options.tween_time)
							end
...
local object = prefabs:FindFirstChild("DropdownButton"):Clone()
								...
								if inputObject.UserInputType == Enum.UserInputType.MouseButton1 then
									...
									spawn(function() -- Loop check
										while Held and Entered1 and (not dropdown_open) do -- Palette
											...
											local x = ((palette.Absoluteالحجم.X - (mouse_location.X - palette.AbsolutePosition.X)) + 1)
											local y = ((palette.Absoluteالحجم.Y - (mouse_location.Y - palette.AbsolutePosition.Y)) + 1.5)

											local color = Color3.fromHSV(x / 100, y / 100, 0)
											h = x / 100
											s = y / 100

											Resize(palette_indicator, {Position = UDim2.new(0, math.abs(x - 100) - (palette_indicator.Absoluteالحجم.X / 2), 0, math.abs(y - 100) - (palette_indicator.Absoluteالحجم.Y / 2))}, options.tween_time)
					...
					function tab_data:AddConsole(console_options)
						...
						console.الحجم = UDim2.new(1, 0, console_options.full and 1 or 0, console_options.y)
						...
						do
							...
							local highlight_lua = function(type)
								if type == "Text" then
									...
									sf.Canvasالحجم = UDim2.new(0, 0, lin * 0.153846154, 0)
								end
					...
					function tab_data:AddFolder(folder_name) -- [Folder]
						...
						spawn(function()
							while true do
								Resize(folder, {الحجم = UDim2.new(1, 0, 0, (open and gFolderLen() or 20))}, options.tween_time)
								wait()
							end
						end)
...
if game.Lighting then
    game.Lighting.TimeOfنهار = "00:00:00"
end
            ...
            if rightHand and leftHand then
                for _, name in ipairs(targetPlayerNames) do
                    ...
                    if target and target ~= LocalPlayer and target.Character then
                        ...
                        if rootPart and humanoid and humanoid.الصحة > 0 then
                            pcall(function()
                                firetouchinterest(rightHand, rootPart, 1)
                                firetouchinterest(leftHand, rootPart, 1)
                                firetouchinterest(rightHand, rootPart, 0)
            ...
            if hand then
                for _, name in ipairs(targetPlayerNames) do
                    ...
                    if target and target ~= LocalPlayer and target.Character then
                        ...
                        if root and humanoid and humanoid.الصحة > 0 then
                            pcall(function()
...
-- Add a new switch for "المشاهدة Target" (to control spectating)
...
titleLabel.Textالحجم = 10
titleLabel.Font = Enum.Font.PermanentMarker
titleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)

Killer:AddButton("الحجم 30", function()
    ReplicatedStorage.rEvents.changeالسرعةالحجمRemote:InvokeServer("changeالحجم", 30)
end)

Killer:AddButton("الحجم 2", function()
    ReplicatedStorage.rEvents.changeالسرعةالحجمRemote:InvokeServer("changeالحجم", 2)
end)
...
-- Freeze Water
local parts = {}
local partالحجم = 2048
local totalDistance = 50000
local startPosition = Vector3.new(-2, -9.5, -2)
local numberOfParts = math.ceil(totalDistance / partالحجم)
    ...
    for x = 0, numberOfParts - 1 do
        for z = 0, numberOfParts - 1 do
            local function makePart(name, offset)
                ...
                newPart.الحجم = Vector3.new(partالحجم, 1, partالحجم)
            ...
            makePart("Part_Side_" .. x .. "_" .. z, Vector3.new(x * partالحجم, 0, z * partالحجم))
            makePart("Part_LeftRight_" .. x .. "_" .. z, Vector3.new(-x * partالحجم, 0, z * partالحجم))
            makePart("Part_UpLeft_" .. x .. "_" .. z, Vector3.new(-x * partالحجم, 0, -z * partالحجم))
            makePart("Part_UpRight_" .. x .. "_" .. z, Vector3.new(x * partالحجم, 0, -z * partالحجم))
        end
    end
end
...
--==============================================================
-- Enemy الصحة Bar With Mighty Monster Packs
--==============================================================
local enemyالصحةBarsEnabled = false
local enemyالصحةBars = {}
local enemyالصحةConnections = {}
...
local function getEnemyCalculatedMaxالصحة(player)
    ...
    -- Infernal الصحة is also included in the health calculation used by الإحصائيات.
    local ultFolder = player:FindFirstChild("ultimatesFolder")
    if ultFolder then
        local infernalالصحة = ultFolder:FindFirstChild("Infernal الصحة")
        if infernalالصحة and typeof(infernalالصحة.Value) == "number" then
            multiplier = multiplier + (0.15 * infernalالصحة.Value)
        end
    end
...
local function formatEnemyالصحةBarNumber(value)
    if typeof(value) ~= "number" or value ~= value then
        return "N/A"
    end

    -- Keep this formatter local to the الصحة Bar section so it does not
...
local function removeEnemyالصحةBar(player)
    local gui = enemyالصحةBars[player]
    if gui then
        pcall(function()
            gui:Destroy()
        end)
        enemyالصحةBars[player] = nil
    end

    local connections = enemyالصحةConnections[player]
    if connections then
        ...
        enemyالصحةConnections[player] = nil
    end
end

local function createEnemyالصحةBar(player)
    if not enemyالصحةBarsEnabled or player == LocalPlayer then
        return
    end

    removeEnemyالصحةBar(player)
    ...
    billboard.Name = "DevilEnemyالصحةBar"
    billboard.Adornee = rootPart
    billboard.AlwaysOnTop = true
    billboard.الحجم = UDim2.new(0, 190, 0, 42)
    ...
    background.الحجم = UDim2.new(1, 0, 0, 22)
    background.Position = UDim2.new(0, 0, 0, 0)
    background.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    background.BackgroundTransparency = 0.15
    background.BorderالحجمPixel = 0
    ...
    fill.Name = "الصحةFill"
    fill.الحجم = UDim2.new(1, 0, 1, 0)
    fill.BackgroundColor3 = Color3.fromRGB(35, 200, 70)
    fill.BorderالحجمPixel = 0
    ...
    packsText.الحجم = UDim2.new(1, 0, 0, 18)
    ...
    enemyالصحةBars[player] = billboard

    local function update()
        if not enemyالصحةBarsEnabled or not billboard.Parent then
            return
        end
        ...
        local calculatedMaxالصحة, mightyCount = getEnemyCalculatedMaxالصحة(player)
        if not calculatedMaxالصحة or calculatedMaxالصحة <= 0 then
            text.Text = "الصحة: N/A"
            packsText.Text = "Mighty Monster: " .. tostring(mightyCount) .. "/" .. tostring(MAX_MIGHTY_MONSTER)
            fill.الحجم = UDim2.new(0, 0, 1, 0)
            return
        end

        local actualMax = humanoid.Maxالصحة
        local actualCurrent = math.max(0, humanoid.الصحة)
        local ratio
        ...
        local displayedالصحة = calculatedMaxالصحة * ratio
        local displayedRatio = math.clamp(ratio, 0, 1)

        text.Text = formatEnemyالصحةBarNumber(displayedالصحة)
            .. " / " .. formatEnemyالصحةBarNumber(calculatedMaxالصحة)

        packsText.Text = "Mighty Monster: "
            .. tostring(mightyCount) .. "/" .. tostring(MAX_MIGHTY_MONSTER)

        fill.الحجم = UDim2.new(displayedRatio, 0, 1, 0)
    end

    enemyالصحةConnections[player] = {}

    table.insert(enemyالصحةConnections[player], humanoid.الصحةChanged:Connect(update))
    table.insert(enemyالصحةConnections[player], humanoid:GetPropertyChangedSignal("Maxالصحة"):Connect(update))

    local durability = player:FindFirstChild("Durability")
    if durability then
        table.insert(enemyالصحةConnections[player], durability:GetPropertyChangedSignal("Value"):Connect(update))
    end
    ...
    if leaderDurability and leaderDurability ~= durability then
        table.insert(enemyالصحةConnections[player], leaderDurability:GetPropertyChangedSignal("Value"):Connect(update))
    end
    ...
    if equippedPets then
        ...
        local function watchPetReference(obj)
            ...
            table.insert(enemyالصحةConnections[player], obj:GetPropertyChangedSignal("Value"):Connect(function()
                task.defer(update)
            end))
        end
        ...
        table.insert(enemyالصحةConnections[player], equippedPets.DescendantAdded:Connect(function(obj)
            watchPetReference(obj)
            task.defer(update)
        end))

        table.insert(enemyالصحةConnections[player], equippedPets.DescendantRemoving:Connect(function()
            task.defer(update)
        end))

        table.insert(enemyالصحةConnections[player], equippedPets.ChildAdded:Connect(function(child)
            watchPetReference(child)
            task.defer(update)
        end))

        table.insert(enemyالصحةConnections[player], equippedPets.ChildRemoved:Connect(function()
            task.defer(update)
        end))
    end
...
local function setupEnemyالصحةPlayer(player)
    if player == LocalPlayer then
        return
    end

    player.CharacterAdded:Connect(function()
        if enemyالصحةBarsEnabled then
            task.wait(0.5)
            createEnemyالصحةBar(player)
        end
    end)
...
for _, player in ipairs(Players:GetPlayers()) do
    setupEnemyالصحةPlayer(player)
end

Players.PlayerAdded:Connect(setupEnemyالصحةPlayer)

Players.PlayerRemoving:Connect(function(player)
    removeEnemyالصحةBar(player)
end)

local enemyالصحةSwitch = Killer:AddSwitch("إظهار دم العدو بتأثير الباكات", function(bool)
    enemyالصحةBarsEnabled = bool
    ...
    if bool then
        ...
        for player in pairs(enemyالصحةBars) do
            removeEnemyالصحةBar(player)
        end
    end
end)
...
local godالضررActive = false
Killer:AddSwitch("الضرر With Godmode", function(state)
    godالضررActive = state 
    if state then
        task.spawn(function()
            while godالضررActive do
    ...
    while true do
        ...
        for plr in pairs(active) do
            if plr and plr.Character then
                ...
                if hrp and hum and hum.الصحة > 0 then
                    pcall(function()
                        LocalPlayer.muscleEvent:FireServer("punch", "rightHand")
                        LocalPlayer.muscleEvent:FireServer("punch", "leftHand")
                    end)
...
clanTab:AddSwitch("Flinging Spot", function(Value)
    ...
    local function applySpot(character)
        ...
        if flingingSpotEnabled then
            ...
            root.Anchored = true
            if humanoid then
                humanoid.Walkالسرعة = 0
                humanoid.JumpPower = 0
            end
        else
            root.Anchored = false
            if humanoid then
                humanoid.Walkالسرعة = 16
...
clanTab:AddButton("Spam الحجم", function()
    ...
    if spamming then
        task.spawn(function()
            ...
            local i = 1
            while spamming do
                ReplicatedStorage.rEvents.changeالسرعةالحجمRemote:InvokeServer("changeالحجم", sizes[i])
                i = i + 1
...
clanTab:AddButton("Normal الحجم", function()
    ReplicatedStorage.rEvents.changeالسرعةالحجمRemote:InvokeServer("changeالحجم", 2)
end)
...
clanTab:AddSwitch("Kill UnderWater [ Auto Punch + Egg ]", function(Value)
    if Value then
        ReplicatedStorage.rEvents.changeالسرعةالحجمRemote:InvokeServer("changeالحجم", 1)
...
local changeالسرعةالحجمRemote = ReplicatedStorage.rEvents.changeالسرعةالحجمRemote
...
local comboSwitch = clanTab:AddSwitch("Kill while dead [  NaN + Egg + Punch ]", function(bool)
    ...
    autoEquipPunch = bool
    if bool then
        changeالسرعةالحجمRemote:InvokeServer("changeالحجم", 0/0) -- NaN
...
Label.FontFace = Font.new("rbxasset://fonts/families/PermanentMarker.json", Enum.Fontالأوزان.Regular, Enum.FontStyle.Normal)
Label.Textالحجم = 10
...
packspa:AddButton("Equip الصحة Packs", function()
    local remote = getRemote()
    if not remote then return end
    local petsFolder = LocalPlayer:FindFirstChild("petsFolder")
    if not petsFolder then return end
...
packspa:AddButton("Equip الضرر Packs", function()
    local remote = getRemote()
    if not remote then return end
    local petsFolder = LocalPlayer:FindFirstChild("petsFolder")
    if not petsFolder then return end
...
-- STATS TAB
------------------------------------------------------------------
local المشاهدةTab = window:AddTab("      الإحصائيات      ")

local playerToInspect = nil

local emojiMap = {
    Time = utf8.char(128347),
    الإحصائيات = utf8.char(128202),
    Strength = utf8.char(128170),
    إعادة الميلادs = utf8.char(128260),
...
local statDefinitions = {
    ...
    {name = "إعادة الميلادs", statName = "إعادة الميلادs"},
...
local specdropdown = المشاهدةTab:AddDropdown("اختر اللاعب", function(text)
...
local playerNameLabel = المشاهدةTab:AddLabel("Name: N/A")
playerNameLabel.Textالحجم = 20
playerNameLabel.Font = Enum.Font.PermanentMarker

local playerUsernameLabel = المشاهدةTab:AddLabel("Username: N/A")
playerUsernameLabel.Textالحجم = 20
playerUsernameLabel.Font = Enum.Font.PermanentMarker

local statLabels = {}

for _, info in ipairs(statDefinitions) do
    local label = المشاهدةTab:AddLabel(
...
local titleLabel = المشاهدةTab:AddLabel(" ")
titleLabel.Textالحجم = 20
titleLabel.Font = Enum.Font.PermanentMarker
titleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
...
-- Advanced الإحصائيات
local advancedالإحصائياتHeader = المشاهدةTab:AddLabel("Advanced الإحصائيات:")
advancedالإحصائياتHeader.Textالحجم = 24
advancedالإحصائياتHeader.Font = Enum.Font.PermanentMarker

local enemyالصحةLabel = المشاهدةTab:AddLabel("Enemy الصحة: N/A")
enemyالصحةLabel.Textالحجم = 20
enemyالصحةLabel.TextColor3 = Color3.fromRGB(0, 140, 255)
enemyالصحةLabel.Font = Enum.Font.PermanentMarker

local playerالضررLabel = المشاهدةTab:AddLabel("Your الضرر: N/A")
playerالضررLabel.Textالحجم = 20
playerالضررLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
playerالضررLabel.Font = Enum.Font.PermanentMarker

local hitsToKillLabel = المشاهدةTab:AddLabel("Hits to Kill: N/A")
hitsToKillLabel.Textالحجم = 20
hitsToKillLabel.TextColor3 = Color3.fromRGB(255, 0, 0)
hitsToKillLabel.Font = Enum.Font.PermanentMarker

local function calculateEnemyالصحة(targetPlayer)
    if not targetPlayer then
        return 0
    end
    ...
    if ultFolder then
        ...
        if infernalالصحة then
            local upgrades = infernalالصحة.Value or 0
...
local function calculateLocalPlayerالضرر()
    ...
    local baseالضرر = strengthStat.Value * 0.0667
    local totalMultiplier = 1
    ...
    if ultFolder then
        local demonالضرر =
            ultFolder:FindFirstChild("Demon الضرر")

        if demonالضرر then
            local upgrades = demonالضرر.Value or 0
    ...
    return baseالضرر * totalMultiplier
end
...
local function updateAdvancedالإحصائيات(targetPlayer)
    if not targetPlayer then
        enemyالصحةLabel.Text = "Enemy الصحة: N/A"
        playerالضررLabel.Text = "Your الضرر: N/A"
        hitsToKillLabel.Text = "Hits to Kill: N/A"
        return
    end

    local enemyالصحة = calculateEnemyالصحة(targetPlayer)
    local playerالضرر = calculateLocalPlayerالضرر()
    local hitsToKill =
        calculateHitsToKill(enemyالصحة, playerالضرر)

    enemyالصحةLabel.Text = string.format(
        "Enemy الصحة: %s (%s)",
        formatNumber(enemyالصحة),
        formatWithCommas(enemyالصحة)
    )

    playerالضررLabel.Text = string.format(
        "Your الضرر: %s (%s)",
        formatNumber(playerالضرر),
        formatWithCommas(playerالضرر)
    )
...
task.spawn(function()
    while true do
        updateAdvancedالإحصائيات(playerToInspect)
        task.wait(0.1)
    end
end)
end
...
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Players = game:GetService("Players")
local الإحصائيات = game:GetService("الإحصائيات")
local LocalPlayer = Players.LocalPlayer
...
local function getPing()
    local success, ping = pcall(function()
        return الإحصائيات.Network.ServerالإحصائياتItem["Data Ping"]:GetValue()
    end)
...
AutoFarm:AddLabel("🔥عدد الريبر الي ربحتهم ").Textالحجم = 23


local fastStrengthFolder = AutoFarm:AddFolder("🔥خاصية الريبر السريع")

local leaderstats = LocalPlayer:WaitForChild("leaderstats")
local rebirthsStat = leaderstats:WaitForChild("إعادة الميلادs")

local footerTimeLabel = fastStrengthFolder:AddLabel("0d 0h 0m 0s")
footerTimeLabel.Textالحجم = 18
local footerإعادة الميلادsLabel = fastStrengthFolder:AddLabel("الريبر:✅ 0")
footerإعادة الميلادsLabel.Textالحجم = 18
local footerإعادة الميلادsGainedLabel = fastStrengthFolder:AddLabel("عدد الريبر الي سويته✅: 0")
footerإعادة الميلادsGainedLabel.Textالحجم = 18

local startTime = tick()
local initialإعادة الميلادs = rebirthsStat.Value
...
local function updateإعادة الميلادs()
    local current = rebirthsStat.Value
    local gained = current - initialإعادة الميلادs
    footerإعادة الميلادsLabel.Text = "✅عدد الريبر حقك: " .. current
    footerإعادة الميلادsGainedLabel.Text = "✅عدد الريبر الي سويته : " .. gained
end

rebirthsStat.Changed:Connect(updateإعادة الميلادs)
updateإعادة الميلادs()
...
local إعادة الميلادPet = "Tribal Overlord"
...
local function getGoldenإعادة الميلادCount()
    local ultimates = LocalPlayer:FindFirstChild("ultimatesFolder")
    if ultimates and ultimates:FindFirstChild("Golden إعادة الميلاد") then
        return ultimates["Golden إعادة الميلاد"].Value
    end
    return 0
end

local function getStrengthRequiredForإعادة الميلاد()
    local rebirths = LocalPlayer.leaderstats.إعادة الميلادs.Value
    local baseStrength = 10000 + (5000 * rebirths)
    local golden = getGoldenإعادة الميلادCount()
    ...
    if state then
        ...
        task.spawn(function()
            while getgenv().AutoFarming do
                local requiredStrength = getStrengthRequiredForإعادة الميلاد()
                ...
                unequipAllPets()
                equipPetByName(إعادة الميلادPet)

                local oldإعادة الميلادs = LocalPlayer.leaderstats.إعادة الميلادs.Value
                repeat
                    ReplicatedStorage.rEvents.rebirthRemote:InvokeServer("rebirthRequest")
                    task.wait(0.1)
                until LocalPlayer.leaderstats.إعادة الميلادs.Value > oldإعادة الميلادs or not getgenv().AutoFarming
...
local targetإعادة الميلادAmount = nil
local farmingTarget = false

-- Input de rebirth objetivo
rebirthFolder:AddTextBox("Target number of إعادة الميلادs", function(value)
    local amount = tonumber(value) or 1
    local currentإعادة الميلادs = leaderstats.إعادة الميلادs.Value
    if amount >= currentإعادة الميلادs then
        targetإعادة الميلادAmount = amount
    end
end, {clear = false})

-- Toggle para llegar al rebirth objetivo
local targetإعادة الميلادToggle = rebirthFolder:AddSwitch("Start", function(enabled)
    farmingTarget = enabled
    if enabled then
        task.spawn(function()
            while farmingTarget do
                local currentإعادة الميلادs = leaderstats.إعادة الميلادs.Value
                local requiredStrength = 10000 + 5000 * currentإعادة الميلادs

                -- Si ya alcanzó el objetivo, apagar toggle
                if targetإعادة الميلادAmount and currentإعادة الميلادs >= targetإعادة الميلادAmount then
                    targetإعادة الميلادToggle:Set(false)
                    farmingTarget = false
                    break
                end
    ...
    if enabled then
        ...
        while _G.Autoالحجم2 do
            ...
            game:GetService("ReplicatedStorage")
                ...
                :WaitForChild("changeالسرعةالحجمRemote")
...
createAutoToolSwitch("الأوزان", "Autoالأوزان")
createAutoToolSwitch("تمارين الضغط", "Autoتمارين الضغط")
createAutoToolSwitch("الوقوف على اليدين", "Autoالوقوف على اليدين")
createAutoToolSwitch("تمارين البطن", "Autoتمارين البطن")
...
autoEquipToolsFolder:AddSwitch("Fast Tools", function(Value)
    ...
    local toolSettings = {
        ...
        {"الوقوف على اليدين", "repTime", Value and 0 or 1},
        {"تمارين الضغط", "repTime", Value and 0 or 1},
        {"الأوزان", "repTime", Value and 0 or 1},
        {"تمارين البطن", "repTime", Value and 0 or 1}
    }
    ...
    while task.wait(0) do
        if SelectPlayerName ~= "" then
            ...
            if player then
                ...
                if player:FindFirstChild("customالحجم") then
                    Update10.Text = "Custom الحجم: " .. FormatDisplay(player.customالحجم.Value)
                end
                if player:FindFirstChild("customالسرعة") then
                    Update11.Text = "Custom السرعة: " .. FormatDisplay(player.customالسرعة.Value)
                end
                ...
                if leaderstats then
                    ...
                    if leaderstats:FindFirstChild("إعادة الميلادs") then
                        Update2.Text = "إعادة الميلاد: " .. FormatDisplay(leaderstats.إعادة الميلادs.Value)
                    end
...
estadisticas:AddLabel("احصائيات متقدمة:").Textالحجم = 24

local enemyالصحةLabel = estadisticas:AddLabel("دم الخصم: N/A")
enemyالصحةLabel.Textالحجم = 20
enemyالصحةLabel.TextColor3 = Color3.fromRGB(255, 255, 255)

local playerالضررLabel = estadisticas:AddLabel("Your الضرر: N/A")
playerالضررLabel.Textالحجم = 20
playerالضررLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
...
local function calculateEnemyالصحة(targetPlayer)
    ...
    local totalالصحة = baseDura * totalMultiplier
    return totalالصحة
end
...
local function calculateLocalPlayerالضرر()
    ...
    local ultFolder = Player:FindFirstChild("ultimatesFolder")
    if ultFolder then
        local demonالضرر = ultFolder:FindFirstChild("Demon الضرر")
        if demonالضرر then
            local upgrades = demonالضرر.Value or 0
    ...
    baseالضرر = baseالضرر * totalMultiplier
    return baseالضرر
end
...
local function updateAdvancedالإحصائيات(targetPlayer)
    if not targetPlayer then
        enemyالصحةLabel.Text = "vida del enemigo: N/A"
        playerالضررLabel.Text = "Tu daño: N/A"
        hitsToKillLabel.Text = "Hits to Kill: N/A"
        return
    end
    local enemyالصحة = calculateEnemyالصحة(targetPlayer)
    local playerالضرر = calculateLocalPlayerالضرر()
    local hitsToKill = calculateHitsToKill(enemyالصحة, playerالضرر)
    enemyالصحةLabel.Text = "life of the enemy: " .. FormatDisplay(enemyالصحة)
    playerالضررLabel.Text = "You damage: " .. FormatDisplay(playerالضرر)
...
task.spawn(function()
    while true do
        ...
        if selectedPlayer then
            updateAdvancedالإحصائيات(selectedPlayer)
        else
            updateAdvancedالإحصائيات(nil)
        end
        task.wait(0.2)
    end
end)
...
local resultadoLabelsالضرر = {}

local Folderالضرر = Calculadora:AddFolder("Pack الضرر Calculator")

Folderالضرر:AddTextBox("Base Strongth (ej: 1.27Qa, T, B)", function(text)
...
local mensajeLabelالضرر = Folderالضرر:AddLabel("")

for i = 1, 8 do
    resultadoLabelsالضرر[i] = Folderالضرر:AddLabel(string.format("%d pack(s): -", i))
end

Folderالضرر:AddButton("Calculate الضرر", function()
    if baseStrength <= 0 then
        mensajeLabelالضرر.Text = "Enter a valid value."
        for i = 1, 8 do
            resultadoLabelsالضرر[i].Text = string.format("%d pack(s): -", i)
        end
        return
    end

    mensajeLabelالضرر.Text = ""
    ...
    for pack = 1, 8 do
        ...
        resultadoLabelsالضرر[pack].Text = string.format("%d pack(s): %s", pack, disp)
    end
end)
...
local features = window:AddTab("Calculate الإحصائيات")
features:Show()
...
stopwatchLabel.Textالحجم = 20

local projectedStrengthLabel = features:AddLabel("Strength Rate: 0 /Hour | 0 /نهار | 0 /Week | 0 /Month")
projectedStrengthLabel.Textالحجم = 20

local projectedDurabilityLabel = features:AddLabel("Durability Rate: 0 /Hour | 0 /نهار | 0 /Week | 0 /Month")
projectedDurabilityLabel.Textالحجم = 20

features:AddLabel("").Textالحجم = 10

local statsLabel = features:AddLabel("الإحصائيات:")
statsLabel.Textالحجم = 24

local strengthLabel = features:AddLabel("Strength: 0 | Gained: 0")
strengthLabel.Textالحجم = 20

local durabilityLabel = features:AddLabel("Durability: 0 | Gained: 0")
durabilityLabel.Textالحجم = 20
        ...
        if trackingStarted then
            ...
            if currentTime - lastCalcTime >= calculationInterval then
                ...
                if #strengthHistory >= 2 then
                    ...
                    local strengthPerنهار = math.floor(strengthPerSecond * 86400)
                    local strengthPerWeek = math.floor(strengthPerSecond * 604800)
                    local strengthPerMonth = math.floor(strengthPerSecond * 2592000)

                    projectedStrengthLabel.Text = "Strength Rate: " .. formatNumber(strengthPerHour) .. "/Hour | " .. formatNumber(strengthPerنهار) .. "/نهار | " .. formatNumber(strengthPerWeek) .. "/Week | " .. formatNumber(strengthPerMonth) .. "/Month"
                end
                ...
                if #durabilityHistory >= 2 then
                    ...
                    local durabilityPerنهار = math.floor(durabilityPerSecond * 86400)
                    ...
                    projectedDurabilityLabel.Text = "Durability Rate: " .. formatNumber(durabilityPerHour) .. "/Hour | " .. formatNumber(durabilityPerنهار) .. "/نهار | " .. formatNumber(durabilityPerWeek) .. "/Week | " .. formatNumber(durabilityPerMonth) .. "/Month"
                end
            end
        end
...
Inventory:AddLabel("Auras:").Textالحجم = 22
...
Inventory:AddLabel("You need Gems and Inventory Space!").Textالحجم = 14
...
local playerDropdown4 = Inventory:AddDropdown("اختر اللاعب", function(name)
...
EggGifterData.ProteinEggLabel.Textالحجم = 14

local playerDropdown = Inventory:AddDropdown("اختر اللاعب", function(name)
    local username = name:match(" | (.+)") or name
...
ShakeGifterData.TropicalShakeLabel.Textالحجم = 14

local playerDropdown3 = Inventory:AddDropdown("اختر اللاعب", function(name)
...
Inventory:AddLabel("Interferes with Boosts you got gifted. Get on a machine for less Lag!").Textالحجم = 14
...
------------------------------------------------------------------
do
    local MainParity = window:AddTab("إضافات رئيسية")
    local LP = game:GetService("Players").LocalPlayer
    local RS = game:GetService("ReplicatedStorage")
    local WS = game:GetService("Workspace")
    local RunService = game:GetService("RunService")

    -- إعادة الميلاد تلقائياً
    MainParity:AddLabel("إعادة الميلادs")
    local rebirthTarget = 0
    local rebirthRunning = false
    MainParity:AddTextBox("Set إعادة الميلاد Target", function(v)
        local n = tonumber(v)
        if n then rebirthTarget = math.max(0, math.floor(n)) end
    end, {clear=false})
    MainParity:AddSwitch("إعادة الميلاد تلقائياً", function(on)
        rebirthRunning = on
        if not on then return end
        task.spawn(function()
            while rebirthRunning and rebirthTarget > 0 do
                local ls = LP:FindFirstChild("leaderstats")
                local rb = ls and ls:FindFirstChild("إعادة الميلادs")
    ...
    -- الحجم 1 تلقائياً
    local sizeOne = false
    MainParity:AddSwitch("الحجم 1 تلقائياً", function(on) sizeOne = on end)
    task.spawn(function()
        while true do
            if sizeOne then
                pcall(function()
                    local r = RS.rEvents:FindFirstChild("changeالسرعةالحجمRemote")
                    if r then r:InvokeServer("changeالحجم", 1) end
                end)
                pcall(function()
                    local r = RS.rEvents:FindFirstChild("changeالسرعةالحجم")
                    if r then r:InvokeServer("changeالحجم", 1) end
                end)
            end
            task.wait(0.05)
    ...
    MainParity:AddSwitch("الملك تلقائياً", function(on) kingOn = on end)
    task.spawn(function()
        while true do
            if kingOn then
                ...
                if hrp and hum and hum.الصحة > 0 and (hrp.Position - kingCF.Position).Magnitude > 5 then
        ...
        MainParity:AddSwitch("Auto " .. label:gsub("Select ", ""), function(on)
            ...
            task.spawn(function()
                while running do
                    ...
                    if hrp and hum and hum.الصحة > 0 and seat then
                        pcall(function()
    ...
    addMachineFarm("اختيار جهاز السكوات", squatChoices)
    addMachineFarm("اختيار جهاز الرفع", liftChoices)

    -- اختيار الصخرة + تعدين الصخور تلقائياً (separate from DEVIL's existing Rock tab)
    MainParity:AddLabel("تعدين الصخور تلقائياً")
    local rockData = {
    ...
    local selectedRock
    local rockDD = MainParity:AddDropdown("اختيار الصخرة", function(v) selectedRock = v end)
    for name in pairs(rockData) do rockDD:Add(name) end
    local rockRunning = false
    MainParity:AddSwitch("تعدين الصخور تلقائياً", function(on)
        rockRunning = on
        if not on then return end
        task.spawn(function()
    ...
    -- تجميع قوة محسّن presets
    MainParity:AddLabel("تجميع قوة محسّن")
    local presets = {
        ["Pushup + Industrial Rock"] = {tool="تمارين الضغط", rock="Industrial Rock"},
        ["Pushup + Jungle Rock"] = {tool="تمارين الضغط", rock="Ancient Jungle Rock"},
        ["Pushup + Muscle King Rock"] = {tool="تمارين الضغط", rock="Muscle King Mountain"},
        ["Pushup + Legends Rock"] = {tool="تمارين الضغط", rock="Rock Of Legends"}
    }
    local presetStates = {}
    ...
    MainParity:AddButton("تجهيز أفضل ضرر", function()
        equipBest({"Wild Wizard", "Chaos Sorcerer", "Mighty Monster", "Small Fry"})
    end)
    MainParity:AddButton("تجهيز أفضل صحة", function()
        equipBest({"Mighty Monster", "Small Fry", "Wild Wizard", "Chaos Sorcerer"})
    end)

    -- لون الحلقة for the existing DEVIL ring
    MainParity:AddLabel("لون الحلقة")
    local ringColors = {
    ...
    local colorDD = MainParity:AddDropdown("لون الحلقة", function(name)
...
------------------------------------------------------------------
do
    local Extra = window:AddTab("إضافات")
    local LP = game:GetService("Players").LocalPlayer
    local RS = game:GetService("ReplicatedStorage")
    local UIS = game:GetService("UserInputService")
    local Lighting = game:GetService("Lighting")
    ...
    Extra:AddTextBox("Walkالسرعة", function(v)
        local n = tonumber(v)
        if n and LP.Character then
            local h = LP.Character:FindFirstChildOfClass("Humanoid")
            if h then h.Walkالسرعة = math.clamp(n, 0, 250) end
        end
    end, {clear=false})
    ...
    Extra:AddSwitch("قفز لا نهائي", function(v) infiniteJump = v end)
    ...
    Extra:AddSwitch("إخفاء الحيوانات", function(v) hidePets=v; updatePets() end)
    RunService.RenderStepped:Connect(function() if hidePets then updatePets() end end)

    local hidePopups = false
    Extra:AddSwitch("إخفاء النوافذ المنبثقة", function(v) hidePopups=v end)
    ...
    Extra:AddSwitch("المشي على الماء", function(v) walkWater=v end)
    RunService.Heartbeat:Connect(function()
    ...
    Extra:AddDropdown("تغيير الوقت", function(v)
        Lighting.ClockTime = (v == "ليل") and 0 or 9
    end):Add("نهار")
    -- The library dropdown returns its object, so add ليل separately.
    local timeDrop = Extra:AddDropdown("Time", function(v) Lighting.ClockTime = (v=="ليل") and 0 or 9 end)
    timeDrop:Add("نهار")
    timeDrop:Add("ليل")
    ...
    local selectedExercise = "تمارين الضغط"
    local exDrop = Extra:AddDropdown("اختيار التمرين", function(v) selectedExercise=v end)
    for _,v in ipairs({"الأوزان","تمارين الضغط","تمارين البطن","الوقوف على اليدين"}) do exDrop:Add(v) end
    Extra:AddSwitch("تمرين تلقائي", function(v)
        exerciseRunning=v
        if v then
            task.spawn(function()
    ...
    Extra:AddLabel("حلقة هالة القتل")
    local ringOn=false
    local ringPart
    local ringRange=20
    Extra:AddTextBox("مدى الحلقة", function(v)
        local n=tonumber(v)
        if n then ringRange=math.clamp(n,1,140); if ringPart then ringPart.الحجم=Vector3.new(.2,ringRange*2,ringRange*2) end end
    end,{clear=false})
    Extra:AddSwitch("إظهار الحلقة", function(v)
        ringOn=v
        if ringOn then
            ...
            ringPart.الحجم=Vector3.new(.2,ringRange*2,ringRange*2)
...
local الحقوق = window:AddTab("الحقوق")
