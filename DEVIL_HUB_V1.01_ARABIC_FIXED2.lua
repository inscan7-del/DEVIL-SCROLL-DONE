...
-- STATS TAB
------------------------------------------------------------------
local SpecsTab = window:AddTab("      الإحصائيات      ")
...
-- Advanced Stats
local advancedStatsHeader = SpecsTab:AddLabel("Advanced الإحصائيات:")
...
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Players = game:GetService("Players")
local Stats = game:GetService("الإحصائيات")
local LocalPlayer = Players.LocalPlayer
        ...
        if trackingStarted then
            ...
            if currentTime - lastCalcTime >= calculationInterval then
                ...
                if #strengthHistory >= 2 then
                    ...
                    projectedStrengthLabel.Text = "Strength Rate: " .. formatNumber(strengthPerHour) .. "/Hour | " .. formatNumber(strengthPerDay) .. "/نهار | " .. formatNumber(strengthPerWeek) .. "/Week | " .. formatNumber(strengthPerMonth) .. "/Month"
                end
                ...
                if #durabilityHistory >= 2 then
                    ...
                    projectedDurabilityLabel.Text = "Durability Rate: " .. formatNumber(durabilityPerHour) .. "/Hour | " .. formatNumber(durabilityPerDay) .. "/نهار | " .. formatNumber(durabilityPerWeek) .. "/Week | " .. formatNumber(durabilityPerMonth) .. "/Month"
                end
            end
        end
